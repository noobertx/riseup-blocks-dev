...
(function ($) {
    ...
    animatedHeading.prototype.destroy = function () {
        ...
        const $wrapperElement = this.$heading.find('.wprig-animated-text .animated-text-words-wrapper');
    ...
    animatedHeading.prototype.animateHeadline = function ($headlines) {
        ...
        $headlines.each(function () {
            ...
            if (headline.hasClass('loading-bar')) {
                ...
                setTimeout(function () { headline.find('.wprig-animated-text .animated-text-words-wrapper').addClass('is-loading') }, self.barWaiting);
            } else if (headline.hasClass('text-clip')) {
                var spanWrapper = headline.find('.wprig-animated-text .animated-text-words-wrapper'),
                ...
                var words = headline.find('.wprig-animated-text .animated-text-words-wrapper .animated-text.is-visible');
    ...
    $(':not(.block-editor-block-list__layout) .wprig-block-animated-heading .animated-heading-text').each(function () {
