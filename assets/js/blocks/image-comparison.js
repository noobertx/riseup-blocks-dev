...
const imageComparison = function () {
    ...
    const imageComparisonRoot = document.querySelector('.wprig-block-image-comparison');
    const imageComparisonimages = document.querySelectorAll('.wprig-block-image-comparison img');
