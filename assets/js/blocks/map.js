jQuery(document).ready(function ($) {
    ...
    $('.wprig-google-map:not(.wprig-google-map-ready)').each(function () {
        const $mapItem = $(this);
        $mapItem.addClass('wprig-google-maps-ready');
    ...
    //INIT GOOGLE MAP
    function initwprigGoogleMap($mapItem) {
        let styles = '';
        try {
