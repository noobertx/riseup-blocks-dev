...
class Url extends Component {
    ...
    render() {
        ...
        return (
            <div className="wprig-field-url wprig-field">
                {label &&
                    <label>{label}</label>
                }
                <div className="wprig-field-child">
                    <div className="wprig-url-input-group">
                        <input
                        ...
                        />
                        {
                            ...
                            <Tooltip text={__("Advance Url Settings")}>
                                <button className={`wprig-button wprig-button-rounded ${openAdvance ? 'active' : ''}`} onClick={() => this.setState({ openAdvance: !openAdvance })}><i className="fas fa-cog" /></button>
                            </Tooltip>
                        }
                    </div>
                    {openAdvance &&
                        <div className="wprig-url-advance-options">
                            <CheckboxControl
