...
class BorderRadius extends Component {
    ...
    render() {
        ...
        return (
            <div className={"wprig-field wprig-field-border-radius " + (responsive ? 'wprig-responsive' : '')}>
