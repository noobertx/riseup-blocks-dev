...
class ColorAdvanced extends Component {
    ...
    render() {
        ...
        return (
            <div className="wprig-field-color-advanced wprig-field">
                    ...
                    {(value && (value.openColor && value.type) != '') &&
                        <div className="wprig-ml-10">
                            <Tooltip text={__('Clear')}>
                                <span className="wprig-border-clear" onClick={() => this.setSettings(value.openColor ? 0 : 1, 'openColor')} role="button"><i className="fas fa-undo" /></span>
                            </Tooltip>
                        </div>
                    }
                </div>
