...
import ColorAdvanced from './colorAdvance'
...
export const buttonAttributes = {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-wrapper {text-align: {{buttonAlignment}};}',
             },
           ],
         },
         buttonWidthType: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor {width:100% !important; display: -webkit-box; display: -ms-flexbox; display: flex;}',
             },
             {
               condition: [
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor {width:auto !important}',
             },
             {
               condition: [
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor {display:inline-flex}',
             },
           ],
         },
         buttonWidth: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor {width: {{buttonWidth}};}',
             },
           ],
         },
         buttonPadding: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor { color:{{buttonColor}}; }',
             },
           ],
         },
         buttonColor2: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor { color:{{buttonColor2}}; }',
             },
           ],
         },
         buttonHoverColor: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor:hover { color:{{buttonHoverColor}}; }',
             },
           ],
         },
         buttonHoverColor2: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor:hover { color:{{buttonHoverColor2}}; }',
             },
           ],
         },
         buttonBgColor: {
         ...
         buttonBgHoverColor: {
           ...
           default: {
             ...
             gradient: {
               color1: 'var(--wprig-color-1)',
               color2: 'var(--wprig-color-2)',
               type: 'linear',
               direction: 0,
               start: 0,
               stop: 100,
         ...
         buttonBorderHoverColor: {
           ...
           style: [
             {
               selector:
                 '{{WPRIG}} .wprig-block-btn-anchor:hover {border-color: {{buttonBorderHoverColor}};}',
             },
           ],
         },
         ...
         buttonHoverShadow: {
           type: 'object',
           default: {},
           style: [{ selector: '{{WPRIG}} .wprig-block-btn-anchor:hover' }],
         },
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-btn-icon {font-size: {{buttonIconSize}}}',
             },
           ],
         },
         buttonIconGap: {
           ...
           style: [
             {
               ...
               selector:
                 '{{WPRIG}} .wprig-btn-icon { margin-right: {{buttonIconGap}}; }',
             },
             {
               condition: [
                 { key: 'buttonIconName', relation: '!=', value: '' },
               ...
               selector:
                 '{{WPRIG}} .wprig-btn-icon { margin-left: {{buttonIconGap}}; }',
             },
           ],
         },
         buttonGap: {
           ...
           style: [
             {
               selector:
                 '{{WPRIG}} .wprig-block-btn-wrapper { margin-bottom: {{buttonGap}}; }',
             },
           ],
         },
       };
