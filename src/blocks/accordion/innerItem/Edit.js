...
const { Styles, ColorAdvanced, Range, Typography, BoxShadow, RadioAdvanced, Tabs, Tab, Color, Toggle, Padding, Border, BorderRadius, withCSSGenerator, InspectorTabs, InspectorTab } = wp.wprigComponents
        ...
        return (
            <Fragment>
                ...
                <div className={`wprig-block-${uniqueId}${className ? ` ${className}` : ''}`}>
                    <div className={`wprig-accordion-item wprig-type-${fillType} ${(active) ? `wprig-accordion-active` : ''}`}>
                        <div className={`wprig-accordion-panel ${panelIcon && 'wprig-icon-position-' + iconPosition}`}>
                            <div
                                className="wprig-accordion-panel-handler"
                                onClick={() => this._onClickLabel()}
                            >
                                {
                                    (panelIcon && iconPosition == 'left') &&
                                    <span className={`wprig-accordion-icon ${panelIcon}`} />
                                }
                                <RichText
                                    tagName='div'
                                    placeholder={__('Accordion label')}
                                    className="wprig-accordion-panel-handler-label"
                                    value={heading}
                            ...
                            {(isSelectedBlockInRoot) &&
                                <Button
                                    ...
                                    className="wprig-accordion-item-remove-button"
                                >
                                    <i className="fa fa-times" />
                                </Button>
                            }
                        </div>
                        <div className="wprig-accordion-body">
                            <InnerBlocks
