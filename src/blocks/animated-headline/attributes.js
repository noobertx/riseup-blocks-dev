...
export const attributes = {
    ...
    typography: {
        ...
        style: [{ selector: '{{WPRIG}}.wprig-block-animated-heading .animated-heading-text' }]
    },
    textBorderRadius: {
        type: 'object',
        default: {
    ...
    border: { type: 'object', default: {}, style: [{ selector: '{{WPRIG}}.wprig-block-animated-heading' }] },
    bgBorderColorHover: { type: 'string', default: '', style: [{ selector: '{{WPRIG}}.wprig-block-animated-heading:hover {border-color: {{bgBorderColorHover}};}' }] },

    bgShadow: { type: 'object', default: { openShadow: 0, horizontal: 1, vertical: 1, blur: 2, color: 'rgba(0, 0, 0, .2)', spread: 0 }, style: [{ selector: '{{WPRIG}}.wprig-block-animated-heading' }] },
    bgShadowHover: { type: 'object', default: { color: '' }, style: [{ selector: '{{WPRIG}}.wprig-block-animated-heading:hover' }] },
