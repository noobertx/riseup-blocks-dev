...
const attributes = {
    ...
    titleTypography: { type: 'object', default: { openTypography: 1, size: { md: 16, unit: 'px' } }, style: [{ selector: '{{WPRIG}} .wprig-info-box-title' }] },
    titleColor: { type: 'string', default: '#ffffff', style: [{ selector: '{{WPRIG}} .wprig-info-box-title {color: {{titleColor}};}' }] },
    ...
    subTitleTypography: { type: 'object', default: { openTypography: 1, size: { md: 14, unit: 'px' } }, style: [{ selector: '{{WPRIG}} .wprig-block-info-box .wprig-info-box-sub-title' }] },
    subTitleColor: {
    ...
    contentTypography: { type: 'object', default: { openTypography: 1, size: { md: 12, unit: 'px' } }, style: [{ condition: [{ key: 'enableContent', relation: '==', value: true }], selector: '{{WPRIG}} .wprig-info-box-text' }] },
    contentColor: { type: 'string', default: '#ffffff', style: [{ condition: [{ key: 'enableContent', relation: '==', value: true }], selector: '{{WPRIG}} .wprig-info-box-text {color: {{contentColor}};}' }] },
    ...
    // Body
    bgColor: { type: 'object', default: 'rgba(0,0,128,0.5)', style: [{ selector: '{{WPRIG}} .wprig-info-box-media-overlay' }] },
    bgColorHover: { type: 'object', default: {}, style: [{ selector: '{{WPRIG}}:hover .wprig-info-box-media-overlay' }] },
    bgPadding: {
        type: 'object',
        default: {
            paddingType: 'global'
    ...
    bgBorder: { type: 'object', default: '#47a3da', style: [{ selector: '{{WPRIG}} .wprig-block-info-box' }] },
    ...
    bannerHeight: {
        type: 'object',
        default: { md: '170', unit: 'px' },
        style: [
            {
                
                selector: '{{WPRIG}} .wprig-interactive-banner .wprig-info-box-media {min-height: {{bannerHeight}};} '
            }
        ]
    },
