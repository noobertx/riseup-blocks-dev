...
class Edit extends Component {
    ...
    updateColumnWidthAttribute() {
        ...
        const rowWidth = currentColumn.parents('.wprig-backend-row').width()
    ...
    updateColumns(updateType) {
        ...
        if (updateType === 'delete') {
            ...
            innerBlocks.splice(selectedBlockIndex + 1, 0, createBlock('wprig/column', { colWidth: equalWidth }))
        }
    ...
    render() {
        ...
        let resigingClass = 'wprig-column-resizer'
            ...
            <Fragment>
                    ...
                    <InspectorTabs tabs={['style', 'advance']}>
                        <InspectorTab key={'style'}>
                            <PanelBody initialOpen={true} title={__('Dimension')}>
                                <div className={columns === (blockIndex + 1) && responsiveDevice === 'md' ? 'wprig-mb-20 disable-slide' : 'wprig-mb-20'}>
                ...
                {rowWidth !== 0 &&
                    <ResizableBox
                        ...
                        <div className={`wprig-column wprig-column-admin wprig-block-${uniqueId}${className ? ` ${className}` : ''}`} data-column-width={this.props.attributes.colWidth.md}>
