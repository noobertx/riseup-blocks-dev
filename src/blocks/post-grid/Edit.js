						...
						(posts && posts.length) ?
							<Fragment>
								<div
									...
									className={`wprig-postgrid-wrapper wprig-postgrid-layout-${layout} ${(layout === 2) ? 'wprig-postgrid-column wprig-postgrid-column-md' + column.md + ' ' + 'wprig-postgrid-column-sm' + column.sm + ' ' + 'wprig-postgrid-column-xs' + column.xs : ''}`}>
									{
								...
								</div>
								{
									...
									<div className="wprig-postgrid-pagination">
										{
											page > 1 && <button className={'wprig-pagination-prev'} onClick={() => setAttributes({ page: page - 1 })}> <span className="fas fa-angle-left" /> {__('Prev')}</button>
										}
										{
										...
										{
											(page !== pages) && <button className={'wprig-pagination-next'} onClick={() => setAttributes({ page: page + 1 })}>{__('Next')} <span className="fas fa-angle-right" /></button>
										}
									</div>
								}
							</Fragment>
