...
registerBlockType ( 'wprig/divider', {
    ...
    attributes: {
		...
		color: { type: 'string', default: '#252525', style: [{ selector: '{{WPRIG}} .wprig-block-divider > div { border-top-color: {{color}}; } {{WPRIG}} .wprig-block-divider path { fill: {{color}}; } {{WPRIG}} .wprig-block-divider circle { stroke: {{color}}; }  {{WPRIG}} .wprig-block-divider ellipse { stroke: {{color}}; fill: {{color}}; }' }] },
