...
icons.vertical_top = <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g transform="translate(1)" fill="none"><rect class="wprig-svg-fill" x="4" y="4" width="6" height="12" rx="1" /><path class="wprig-svg-stroke" d="M0 1h14" stroke-width="2" stroke-linecap="square" /></g></svg>;
icons.vertical_middle = <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g fill="none"><g transform="translate(1 1)"><rect class="wprig-svg-fill" x="4" width="6" height="14" rx="1" /><path d="M0 7h2" class="wprig-svg-stroke" stroke-width="2" stroke-linecap="square" /></g><path d="M13 8h2" class="wprig-svg-stroke" stroke-width="2" stroke-linecap="square" /></g></svg>;
icons.vertical_bottom = <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g transform="translate(1)" fill="none"><rect class="wprig-svg-fill" x="4" width="6" height="12" rx="1" /><path d="M0 15h14" class="wprig-svg-stroke" stroke-width="2" stroke-linecap="square" /></g></svg>;
...
icons.corner_square = <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"><path d="M0 1h10.967v10.763" stroke-width="2" className="wprig-svg-stroke" fill="none" /></svg>;
icons.corner_rounded = <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"><path d="M0 1h6.967c2.209 0 4 1.791 4 4v6.763" stroke-width="2" className="wprig-svg-stroke" fill="none" /></svg>;
icons.corner_round = <svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"><path d="M0 1h1.967c4.971 0 9 4.029 9 9v1.763" stroke-width="2" className="wprig-svg-stroke" fill="none" /></svg>;
